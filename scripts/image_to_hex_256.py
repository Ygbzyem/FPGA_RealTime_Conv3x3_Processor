...
def generate_hex_file(image_path, output_hex_name, size=(256, 256)):
    ...
    cv2.imwrite("256_grayscale_preview.png", resized_img)
...
generate_hex_file('test.png', 'input_data_256.hex', size=(256, 256))